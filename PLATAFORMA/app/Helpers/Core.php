...
class Core
{
    ...
    public static function getSetting()
    {
        ...
        $layout = CustomLayout::select(
            ...
            'custom_modal_pop',
            'idPixelGoogle',
            'maiores_ganhos_img_icon',
            'maiores_ganhos_status',
            'live_ganhos_status',

            'rodadas_gratis_tabela1_texto1',
            'rodadas_gratis_tabela1_texto2',
            'rodadas_gratis_tabela2_texto1',
            'rodadas_gratis_tabela2_texto2',
            'rodadas_gratis_tabela3_texto1',
            'rodadas_gratis_tabela3_texto2',
            'rodadas_gratis_titulo_texto',
            'rodadas_gratis_status',
            'rodadas_gratis_imagem',
            'maior_de_18_status',
            'baixar_app_imagem',
            'menucell_img_esportes',
